      ...
      <main className="relative flex flex-col items-center justify-center gap-40 overflow-x-hidden overflow-y-clip p-8 md:p-24">
        ...
        >
          <h2 className="text-center text-3xl">
            Transformez votre présence en ligne avec des solutions web sur
            mesure
          </h2>
          <p>
            ...
            <strong>entrepreneur</strong> ou une <strong>association</strong>,
            je suis là pour réaliser un site web qui vous ressemble et qui
          ...
          <motion.div className="relative flex w-full flex-col flex-wrap gap-6 md:grid md:grid-cols-2 md:grid-rows-2">
            ...
            >
              ...
              <p>
                ...
                des interfaces utilisateur dynamiques et réactives. Mise en
                place de bases de données et de services robustes pour assurer
                la fiabilité et la performance de vos applications.
              </p>
            </motion.div>
            <motion.div
              whileHover={{
